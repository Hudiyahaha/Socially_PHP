...
class FollowingActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val followingRef = FirebaseDatabase.getInstance().getReference("Following").child(currentUid)
        followingRef.get().addOnSuccessListener { snap ->
            ...
            Toast.makeText(this, "Failed to load following: ${it.message}", Toast.LENGTH_SHORT).show()
        }
    }
}
